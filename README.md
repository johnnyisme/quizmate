...
- `src/__tests__/`：完整單元測試套件（839 tests, ~90% 覆蓋率：前端邏輯、Gemini SDK 整合、API Key 輪替、錯誤處理、資料庫 LRU、主題切換、對話管理、側邊欄響應式行為、滾動按鈕、Session Hover 按鈕、Markdown 渲染、HTML 安全性、語法高亮、表格橫向滾動、工具函數）
